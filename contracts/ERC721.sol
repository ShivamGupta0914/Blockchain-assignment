...
contract ERC721Token is ERC721 {
    ...
    /// @dev this function internally calls _safeTransferFrom function.
    ...
    /// @dev calls internal function _transFrom. 
    ...
    */
    function approve(address _approved, uint256 _tokenId) external {
        ...
        require(owner[_tokenId] == msg.sender, "owner does not own this token");
